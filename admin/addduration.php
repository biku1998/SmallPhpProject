...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Duration Details</h1>
                </div>
            </div>
			<?php
				if(isset($_POST['submit'])){
					...
					$s="select * from duration where duration='$c'";
					$r=mysqli_query($con,$s);
					if($r){
						$rec=mysqli_num_rows($r);
						if($rec>0){
							echo "<script> alert('Duration Already Added.');</script>";
						}else{
							$sql="insert into duration(duration,fee) values('$c','$d')";
							$run=mysqli_query($con,$sql);
							if($run){
								echo "<script> alert('Duration Added Successfully');</script>";
							}
						}
					}
				}
			...
			<form action="addduration.php" method="POST">
