        ...
        <div class="container-fluid">
            ...
            <?php
             if(isset($_POST['submit'])){
              $l=$_POST['location_name'];
              $a=$_POST['address'];
              include_once('connection.php');
              $s="select * from location where location ='$l' and address='$a'";
              ...
              if($q){
                ...
                if($row>0){
                    ...
                    $qu="insert into location(location,address) values('$l','$a') ";
                    $run=mysqli_query($con,$qu);
                    if($run){
                        echo "<script>alert('location added  succesfully');</script>";
                    }
